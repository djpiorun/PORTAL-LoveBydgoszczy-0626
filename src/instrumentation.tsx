...
function ErrorDialog({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70 p-4">
      <div className="w-full max-w-4xl rounded-3xl border border-red-500/50 bg-red-700 p-6 text-white shadow-2xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-lg font-bold">Runtime Error</h2>
          ...
          <button
            ...
            className="rounded-full bg-white/10 px-3 py-1 text-sm font-semibold transition-colors hover:bg-white/20"
          >
            Zamknij
          </button>
        </div>
        <div className="mt-4">
          <Collapsible>
            ...
            <CollapsibleContent className="max-w-[460px]">
              <div className="mt-2 max-h-60 max-w-full overflow-x-auto rounded bg-neutral-800 p-3 text-sm text-white [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
